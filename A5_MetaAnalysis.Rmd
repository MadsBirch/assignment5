...
#Make model
m = rma(yi,vi, data= PitchRange, slab = Article)
...
#SD of pitch
sd_control = sd(data_3$mean[data_3$Diagnosis == 0])
sd_schizo = sd(data_3$mean[data_3$Diagnosis == 1])
...
one_row = c('ExpMeth & al', 2017, ss_schizo, ss_control, m_control, sd_mean_control, m_schizo, sd_mean_schizo, sd_control, sd_schizo, sd_control_sd, sd_schizo_sd, our_study$yi[1], our_study$vi[1])

one_row

#Add the row to PitchRange
# PitchRange = rbind(PitchRange, one_row)
